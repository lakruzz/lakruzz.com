...
In general there are too many manual steps in the _Front End_ release process.
...
However, you have a low _bus factor_ here. Therefore we would recommend that some effort be put into opening up the _information bottleneck_.
...
6. Automate _Front Office_'s manual processes and put them into a pipeline.
