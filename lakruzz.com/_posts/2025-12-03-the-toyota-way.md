...
excerpt: "A summary of the 14 principles in Jeffery Liker's \"The Toyota Way\". A quick recap for anyone who wants to learn the very basics of The Toyota Way."
search: true
toc: true
toc_sticky: true
author: Lars Kruse
...
<img width="602" alt="image" src="/assets/images/posts/toyotaway/toyota-4p.png"><br clear="both"/>
...
1. Long-term system thinking

{% include gallery id="philosophy" caption="Click the slides to read about the details of each principle" %}
...
{% include gallery id="process" caption="Click the slides to read about the details of each principle" %}
...
{% include gallery id="people" caption="Click the slides to read about the details of each principle" %}
...
{% include gallery id="problem-solving" caption="Click the slides to read about the details of each principle" %}
