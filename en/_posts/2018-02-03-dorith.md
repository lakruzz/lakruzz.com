...
DORITH is a contraction of sentence "DO the RIght THing". It's a principle that enables people to perform their everyday work, in a way that continuously brings them closer to their desired end-goal.
{: .kicker}
...
It may derive from an occupational hazard; We're in the software development business and the [agile manifesto](http://www.agilemanifesto.org){: target="_blank"} tends to be our credo. We honestly belive in motivated and self-organized teams, we belive in meritocracy and we acknowledge that requirements are constantly changing, we belive in technical excellence and in the focus that comes from minimizing work in progress - and we belive in retrospectives and continuous reflections as the primary input for continuous learning. We belive that creating value - such as working software - should be the primary measure of progress.
